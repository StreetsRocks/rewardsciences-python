...
"""
    rewardsciencesapilib.controllers.activities
...
class Activities(BaseController):
    ...
    def track(self,
                ...
                price = None,
                record_id = None):
        """Does a POST request to /activities.

        This endpoint lets you track the activities your users perform.

        Args:
            user_id (int): The ID of the user who is performing the activity.
            activity_type (string): The type of activity the user is
                performing. Example: 'purchased-a-product'
            price (int, optional): The price related to the activity, if any.
                Expressed in USD
            record_id (string, optional): The ID for the record associated
                with the activity in your database.
        ...
        if user_id == None:
            ...
            raise ValueError("Required parameter 'activity_type' cannot be None.")
